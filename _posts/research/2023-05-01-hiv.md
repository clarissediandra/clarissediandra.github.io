...
![Figure1Circular0Dichroism](/assets/img/research/hiv/Circular%20Dichroism.png){: width="100%" }
*Figure 1. Analysis on the integrity of the secondary structure of wild-type and mutant Nef proteins.*
...
1A), whereas the G2A mutant exhibited a slightly reduced value, suggesting a slight
decrease in alpha-helical content. This observation is supported by K2D3 structural
predictions (Figures 1B-E), which also indicate a minor reduction of less than 1% decrease
...
![Figure2ConfocalMicroscopy+FlowCytometry](/assets/img/research/hiv/Confocal%20Microscopy%20+%20Flow%20Cytometry.png){: width="75%" }
*Figure 2. CD4 expression in HeLa cells in the presence of WT-Nef, and Nef mutants (G2A and AxxA).*
<div style="margin-top:-10px;"></div>
...
the AxxA mutant showed no detectable binding and no dissociation constant (Figure 3D),
